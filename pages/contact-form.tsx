    ...
    <body className="bg-gray-800 text-gray-100 px-8 py-12">
      ...
      <div
        ...
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">WhatSend!</h2>
            <div className="text-gray-700 mt-8">
              Send Message to WhatsApp contacts without saving!
            </div>
          </div>
        ...
        <div className="">
          <div>
            ...
            <select className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"  disabled>
